...
<title>Парсер Хитов Yandex</title>
...
<body>
	<span style="display:block;margin-left:auto;margin-right:auto;font-size:22px;color:purple;" onclick="parse_stat();">ХИТЫ</span><br/> 
	...
	Добро пожаловать в Статистику по Хитам<br/><br/>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<span>Каталог</span> #CATS#<br/>
		<span>Брэнд</span> #BRANDS#<br/>
		<input type="checkbox" name="dwl" value="1" id="dwl"/><label for="dwl">Скачать файл</label><br/>		
